...
export default function AdminTierConfigPage() {
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <p className="text-sm font-medium text-slate-500">Tier configuration</p>
      <h1 className="mt-2 text-2xl font-semibold text-slate-900">Tier config</h1>
      <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">
        Tier timing, qualification thresholds, and score deduction settings will be
