...
/**
 * GET /api/admin/notices/upload-video/[uploadId]/status
 *
 * Polls the Mux upload → asset pipeline so the admin notice form can wait for
 * the asset to be ready and grab the HLS playback URL. Admin-only.
